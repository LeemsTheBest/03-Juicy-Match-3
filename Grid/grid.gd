...
# Piece Stuff
var possible_pieces = [
	load("res://Pieces/Bubble.tscn"),
	load("res://Pieces/Fire.tscn"),
	load("res://Pieces/Leaf.tscn"),
	load("res://Pieces/Lightning.tscn"),
	load("res://Pieces/Earth.tscn"),
	load("res://Pieces/Star.tscn"),
	load("res://Pieces/Sky.tscn"),
]
